...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "0WNXiBYL#APD6eHPWyj5b32bDaQx_ObrdEl38Du0gjiFnqv4HL_E",
  // ADD Your Session Id 
  ...
  packname: process.env.packname || "xCHAMO",
  author: process.env.author || "xCHAMO",
  //==========================================- API-CONFIGS -==========================================================
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `🚀 *_CHAMO-MD Connected Successfully!_* ✅ 

--- *_Welcome to CHAMO-MD!_* 🦊🤍 
...
_Thank you for using_ *CHAMO-MD 🦊🤍.*
